                        ...
                        <div class="main-container fl-wrap fix-container-init">
                            ...
                            @if ($chiTietTin)
                                <div class="single-post-header fl-wrap">
                                    <a class="post-category-marker" href="#">{{ $chiTietTin->ten_danh_muc }}</a>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="list-post fl-wrap">
                                                ...
                                                <div class="list-post-content">
                                                    <h3><a
                                                            href="{{ url('/chi-tiet-tin', ['id' => $item->id_tin]) }}">{{ $item->tieu_de }}</a>
                                                    </h3>
                                                    <span class="post-date"><i class="far fa-clock"></i>
                                                        0{{ $item->ngay_dang }}</span>
                                                </div>
                                            </div>
                                            <!--list-post end-->
                                        </div>
                                ...
                                @foreach ($binhLuan as $item)
                                    <li class="comment">
                                        ...
                                        <div class="comment-body smpar">
                                            ...
                                            <div class="clearfix"></div>
                                            <p>{{ $item->noi_dung }}</p>
                                            <div class="comment-meta"><i
                                                    class="far fa-clock"></i>{{ $item->ngay_binh_luan }}</div>
                                ...
                                <div id="addcom" class="clearafix">
                                    ...
                                    <div class="comment-reply-form fl-wrap">
                                        <form id="add-comment" class="add-comment custom-form" method="POST"
                                            action="{{ route('comment', $chiTietTin->id) }}">
                                            @csrf
                                            <fieldset>
                                                <textarea placeholder="Viết bình luận:" name="loibinhluan"></textarea>
                                            </fieldset>
                                            <button class="btn float-btn color-btn" type="submit">Gửi bình luận <i
                            ...
                            <div class="box-widget-content">
                                <ul class="cat-wid-list">
                                    @foreach ($demDanhMuc as $item)
                                        <li><a
                                                href="#">{{ $item->ten_danh_muc }}</a><span>{{ $item->soLuongTin }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
